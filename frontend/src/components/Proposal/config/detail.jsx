...
const DetailDataProposal = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const filteredVerifikasi = verifikasiRes.data.data.find((verifikasi) => verifikasi._id === id);
        const filteredEvaluasi = evaluasiRes.data.data.find((evaluasi) => evaluasi._id === id);
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto bg-white shadow-lg rounded-lg">
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="flex">
          <span className="font-semibold text-gray-600 capitalize w-1/2">Tahun:</span>
        ...
        <div className="flex">
          <span className="font-semibold text-gray-600 capitalize w-1/2">Status:</span>
...
export default DetailDataProposal;
