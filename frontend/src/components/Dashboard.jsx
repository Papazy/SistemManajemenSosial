      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="flex flex-col space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <button className="w-full h-80 bg-gradient-to-t from-blue-500 text-white rounded-lg flex items-center justify-center text-xl relative transition hover:text-[#bfd1fb] hover:scale-105">
            <img
              src={imageInputData}
              alt="Input Data"
            ...
            <button className="w-full h-80 bg-gradient-to-t from-blue-500 text-white rounded-lg flex items-center justify-center text-xl relative transition hover:scale-105 hover:text-[#bfd1fb]">
            <img
              src={imageListData}
              alt="list Data"
              className="w-full h-full object-cover"
